...
(volatile 解释)[https://zhuanlan.zhihu.com/p/33074506]
...
2.使用new生成的，在调用delete 时手动释放
![C++类的析构函数谁来调用？ - wuxinliulei的回答 - 知乎](https://www.zhihu.com/question/23903172/answer/65014974)
...
![关于对象不能直接访问私有成员的超级大误区~](https://blog.csdn.net/qq_37385726/article/details/70957651)
简单介绍：类中函数可以访问同一类的不同对象的private成员，思考（这里的访问本身应该是在类上定义和实现的，且因为是静态语言，也许是编译阶段就确定的）
